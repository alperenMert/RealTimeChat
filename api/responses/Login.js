...
module.exports = function Login(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.Login()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.Login()` called with an Error:', optionalData);
